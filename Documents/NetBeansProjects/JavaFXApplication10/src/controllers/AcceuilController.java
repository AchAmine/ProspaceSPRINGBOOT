...
public class AcceuilController implements Initializable {
    ...
    @FXML
    private VBox panneauPrincipalEmplois;
    @FXML
    ...
    @FXML
    void voirEmploisCLiquer(MouseEvent event){
        ChangeDansLesPanneaux(panneauPrincipalEmplois,"Timetable");
    }
    ...
    void agrandirANDminimiseCliquer(MouseEvent event) throws FileNotFoundException {
        ...
        if (!stage.isMaximized()) {
            ...
            imageMaxMin.setImage(new Image(getClass().getResource("/icons/squaremax.png").toString()));
        } else {
            stage.setMaximized(false);
            imageMaxMin.setImage(new Image(getClass().getResource("/icons/squaremin.png").toString()));
        }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Image im = new Image(getClass().getResource("/images/logo_supptic.jpg").toString());
    ...
    public void ChangeDansLesPanneaux(Pane root, String fieldFXML) {
        try {
            ...
            AnchorPane pan = FXMLLoader.load(getClass().getResource("/fxml/" + fieldFXML + ".fxml"));
