...
import com.prospace.spring.JwtAndAuthConf.AuthEntryPointJwt;
import com.prospace.spring.JwtAndAuthConf.AuthTokenFilter;
import com.prospace.spring.JwtAndAuthConf.UserDetailsServiceImpl;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/api/test/**","/Offer/**","/Quizz/**","/Rating/**","/Quizz/Question/**","/Quizz/Answer/**","/Quizz/Score/**","/Quizz/Question/Answers/**","/Offer/Rating/**","/genrateAndDownloadQRCode/**","/genrateQRCode/**","/pdf/generate/**",
                		"/Article/**","/Article_comments/**","/Article_reactions/**").permitAll()
