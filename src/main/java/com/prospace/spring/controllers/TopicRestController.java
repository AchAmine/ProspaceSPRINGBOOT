...
public class TopicRestController {
	...
	@GetMapping("/retrieve-all-topics/{section-id}")
	public List<Topic> getSections(@PathVariable("section-id") Long sectionId) {
		List<Topic> listTopics = topicService.retrieveAllTopics(sectionId);
		return listTopics;
	}
